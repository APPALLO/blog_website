...
<div class="col-auto p-0">
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="yazilar.php" class="nav-link <?php echo $aktif_sayfa === 'yazilar' ? 'active' : ''; ?>">
            ...
            <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'aktiviteler.php' ? 'active' : ''; ?>" href="aktiviteler.php">
                <i class="fas fa-history me-2"></i>Aktiviteler
            </a>
            <li class="nav-item">
                <a href="cop_kutusu.php" class="nav-link <?php echo $aktif_sayfa === 'cop_kutusu' ? 'active' : ''; ?>">
                    <i class="fas fa-trash-alt me-2"></i>Geri Dönüşüm Kutusu
                    <?php
                    $silinen_yazi_sayisi = $conn->query("SELECT COUNT(*) as sayi FROM blog_yazilar WHERE durum = 'silindi'")->fetch_assoc()['sayi'];
                    if ($silinen_yazi_sayisi > 0):
                    ?>
                    <span class="nav-badge"><?php echo $silinen_yazi_sayisi; ?></span>
                    <?php endif; ?>
                </a>
            </li>
